...
if (args & (excep = ["--without", "source"]) != excep)
  group :source do
    ...
    get_local_if_exists("vigilem-assembly", "../vigilem-assembly", "https://github.com/jtzero/vigilem-assembly.git")
    get_local_if_exists("vigilem-win32_api-stat", "../vigilem-win32_api-stat", "https://github.com/jtzero/vigilem-win32_api-stat.git", :require => false)
    get_local_if_exists("vigilem-evdev-stat", "../vigilem-evdev-stat", "https://github.com/jtzero/vigilem-evdev-stat.git", :require => false)
  end
end
